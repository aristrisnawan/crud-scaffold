...
class BarangsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create barang" do
    assert_difference('Barang.count') do
      post barangs_url, params: { barang: { harga: @barang.harga, jenis: @barang.jenis, nama: @barang.nama } }
    end
  ...
  test "should update barang" do
    patch barang_url(@barang), params: { barang: { harga: @barang.harga, jenis: @barang.jenis, nama: @barang.nama } }
